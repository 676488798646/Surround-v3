555local Players = game:GetService("Players")
...
Watermark.Text = "Super Ring V3] -由小欣破解"
...
local radius = 50
local height = 100
local rotation speed = 10
local Attraction Strength = 10000000
local ring component enabled = false
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    ToggleButton.Text = ringPartsEnabled and "黑洞开" or "黑洞关"
...
SendChatMessage("我只是汉了化")
SendChatMessage("由yumm制作的环绕v3")
